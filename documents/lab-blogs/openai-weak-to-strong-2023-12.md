...
- We are releasing
[open source code(opens in a new window)](https://github.com/openai/weak-to-strong)to make it easy to get started with weak-to-strong generalization experiments today. - We are launching a
[$10 million grants program](/index/superalignment-fast-grants/)for graduate students, academics, and other researchers to work on superhuman AI alignment broadly. We’re especially excited to support research related to weak-to-strong generalization.
